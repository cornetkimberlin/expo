    ...
    return (
      <WebView
        ...
        injectedJavaScriptBeforeContentLoaded={[
          ...
          autoSize ? getInjectBodySizeObserverScript() : null,
        ...
        onMessage={(event) => {
          ...
          if (type === NATIVE_ACTION) {
            const action = getNativeAction(marshalProps, data.actionId);
            if (action == null) {
...
function getNativeAction(
  marshalProps: DOMProps,
  actionId: string
): MarshalPropValueType | undefined {
  return marshalProps?.[actionId] as MarshalPropValueType | undefined;
}
